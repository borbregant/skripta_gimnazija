...
\begin{zgled}
    S pomočjo paralelograma nariši trikotnik $ABC$, kjer $b=4cm$, $t_a =4.5cm$ in $\alpha=75\degree$.\\
...
\begin{zgled}
    Če $n$-kotniku podvojimo število stranic, se njegovo število diagonal pomnoži z $5$. Kateri $n$-kotnik je to. \textcolor{gray}{$\frac{n(n-3)}{2}=\frac{2n(2n-3)}{2}$}
\end{zgled}
