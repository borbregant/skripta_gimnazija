...
\begin{zgled}
    Izračunaj $\Lim{x\rightarrow\infty} \left(1+\frac{1}{2x}\right)^{x}$, $\Lim{x\rightarrow\infty} \left(1+\frac{1}{x}\right)^{3x}$ in $\Lim{x\rightarrow\infty} \left(1+\frac{1}{4x}\right)^{5x}$.
\end{zgled}

\begin{zgled}
    Izračunaj $\Lim{x\rightarrow\infty}\left(\frac{5x+3}{5x-7}\right)^x$ in $\Lim{x\rightarrow\infty}\left(\frac{3x-1}{x+2}\right)^x$ in $\Lim{x\rightarrow\infty}\left(\frac{x+2}{x+5}\right)^{x+1}$
\end{zgled}
